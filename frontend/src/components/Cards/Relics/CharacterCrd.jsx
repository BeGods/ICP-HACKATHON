...
const CharacterCrd = ({ id }) => {
  ...
  return (
    <CardWrap
      Front={
        <div className="w-full h-full relative flex justify-center items-center card-shadow-white">
          <div
          ...
          />
          <div
            className={`absolute top-0 left-3 text-[2.75rem] text-black-contour font-symbols z-10`}
          >
            {selectedChar.icon}
          </div>
