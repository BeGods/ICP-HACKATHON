...
const QuestCard = ({
  ...
  return (
    <div className="w-[70%] -mt-1 relative flex flex-col gap-2 justify-center items-center mx-auto bg-red-400">
      <div className={`card ${flipped ? "flipped" : ""} bg-green-400`}>
        <div
          onClick={(e) => {
      ...
      <div className={`font-symbols text-[15vw]`}>
        <div
          className={`button ${buttonFlip ? "flipped" : ""} text-black-contour`}
        >
          <div className="button__face button__face--front flex justify-center items-center">
            {Button}
          </div>
          <div className="button__face button__face--back h-[20px] w-[20px] flex justify-center items-center">
            {ShareButton}
          </div>
        </div>
      </div>
