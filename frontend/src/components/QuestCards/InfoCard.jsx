...
const InfoCard = ({
  ...
  return (
    <div className="fixed flex flex-col justify-center items-center inset-0 bg-black backdrop-blur-sm bg-opacity-60 z-50">
      <div
        style={{
          backgroundImage: `url(/assets/cards/320px-info_background.png)`,
        ...
        className="flex flex-col items-center gap-4 w-[72%] h-[55%] mt-[73px] glow-card"
      >
        <IconButton
          isInfo={false}
        ...
        <div className="flex -mt-[5px]">
          <img
            src={`/assets/cards/188px-${mythSections[activeMyth]}.quest.${quest?.type}_info_painting.png`}
            alt="info_painting"
