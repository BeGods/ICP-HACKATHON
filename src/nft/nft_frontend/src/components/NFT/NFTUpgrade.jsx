...
const NFTUpgradeModal = ({ onClose }) => {
      ...
      listedNfts.forEach((eachItem) => {
        ...
        if (!groupedNFTs[key]) {
          groupedNFTs[key] = {
            ...
            nftType,
            rarity,
            nextRarity: rarities[rarities.indexOf(rarity) + 1],
            possibleUpgrades: 0,
            canUpgrade: false,
            chain,
            arstistname,
  ...
  const rarities = ["common", "uncommon", "mythical", "divine"];
          ...
          <div className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
              <div className="flex flex-col items-center justify-center space-y-4">
                ...
                <div className={`relative overflow-hidden mx-auto max-w-48`}>
                  <img
                ...
                <div className="text-center space-y-2">
                  ...
                  <div className="space-y-1 text-sm">
                    {selectedUpgrade.tokenIds.slice(0, 3).map((id, index) => (
            ...
            <div className="mt-6 p-4 bg-orange-900/20 border border-orange-800/30 rounded-lg">
              <p className="text-orange-200 text-sm text-center">
                <strong>Warning:</strong> This action will permanently burn the
                selected NFTs. This cannot be undone.
              </p>
            </div>
          </div>
        )}
